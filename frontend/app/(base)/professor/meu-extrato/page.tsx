...
export default function MeuExtratoProfessor() {
    ...
    // Dados mockados de exemplo para professor
    const transactions: Transaction[] = [
        {
            id: "1",
            data: "30/10/2025",
            transacao: "Envio de Moedas",
            parceiro: "Aluno Gabriel Assis",
            valor: -100,
        ...
        },
        {
            id: "2",
            data: "30/10/2025",
            transacao: "Recarga Semestral",
            parceiro: "Sistema",
            valor: 1000,
            motivoItem: "Crédito Semestral Automático"
        },
        {
            id: "3",
            data: "30/10/2025",
            transacao: "Envio de Moedas",
            parceiro: "Aluno João Pedro Peres",
            valor: -100,
            motivoItem: "Desempenho e Qualidade"
        },
        {
            id: "4",
            data: "30/10/2025",
            transacao: "Envio de Moedas",
            parceiro: "Aluno Luís Henrique",
            valor: -100,
            motivoItem: "Superação e Esforço"
        }
    ];
